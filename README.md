...
| uname | Çekirdek sürümünü ve sistem bilgilerini gösterir. |
| echo | Kullanıcı tarafından girilen metni ekrana yansıtır. |
| cls | Terminal ekranını temizler. |
| reboot | Sistemi güvenli bir şekilde yeniden başlatır. |
| logo | WhiteX'in özel ASCII sanat logosunu görüntüler. |
...
Sistemi derlemek için Clang ve LLD araç zinciri gereklidir. MyOS.bin dosyası, uygun bir emülatör (QEMU vb.) veya gerçek donanım üzerinde boot edilebilir.
